                ...
                <tbody>
                  ...
                  while ($row = mysqli_fetch_array($resultado)){?>
                    <tr>
                      ...
                      <td><a href="../del/delete.php?id=<?php echo $row['fav_cli_id']?>" style="background:orange" onclick="return confirmar('¿Está seguro que desea eliminar el registro?')">  <i class="tf-ion-ios-trash"></i> DEL  </a></td>
                    </tr>
                  <?php   
                  }
                  ?>
