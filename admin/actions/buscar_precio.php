              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  while ($row = mysqli_fetch_array($resultado)){?>
                    ...
                    <td><a href="../edit/edit.php?id=<?php echo $row['fav_cli_id']?>" class="marca4" onclick="return confirmar('¿Está seguro que desea editar el registro?')">  <i class="tf-ion-ios-compose-outline"></i> EDIT </a><a href="../del/delete.php?id=<?php echo $row['fav_cli_id']?>" style="background:orange" onclick="return confirmar('¿Está seguro que desea eliminar el registro?')">  <i class="tf-ion-ios-trash"></i> DEL  </a></td>
