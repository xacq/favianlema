...
$sql = "SELECT * FROM fav_codigo WHERE fav_cod_id = 4";
          ...
          <fieldset>
            ...
            <div class="row">
              ...
              <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                  ...
                  <input name="expediente" class="normal_input_little maximus" onkeypress="return valideKeys(event);"  ></div>
                <div class="col-md-6 col-sm-12 col-xs-12">  
                  <label >Nombre del Fiscal</label> 
                  <input name="fiscal" class="normal_input_little maximus"  onkeypress="return valideKeys(event);" ></div>
                <div class="col-md-6 col-sm-12 col-xs-12">  
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">  
                  ...
                  <div class="col-md-6 col-sm-12 col-xs-12">  
                    ...
                    <input name="cli_telefono" class="normal_input_little"    onkeypress="return valideKey(event);"></div></div>
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">  
                        <label >Teléfono</label> 
                        <input name="con_telefono" class="normal_input_little"    onkeypress="return valideKey(event);"></div></div>
              </fieldset>
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <input name="del_otros" class="normal_input_little maximus"  onkeypress="return valideKeys(event);" disabled id="inputa"> </div>
