...
$query = "SELECT * FROM fav_clientes INNER JOIN fav_constitucional WHERE fav_cli_codigo = fav_con_codigo";
...
while ($row = mysqli_fetch_array($resultado)){
    ...
    $pdf->Cell(30,6, utf8_decode($row['fav_con_proceso']),1,0,0);
    $pdf->Cell(30,6, utf8_decode($row['fav_cli_identificacion']),1,0,0);
    $pdf->Cell(70,6, utf8_decode($row['fav_cli_nombre']),1,0,0);
    $pdf->MultiCell(40,6, utf8_decode($row['fav_cli_telefono']),1,1,false);
}
$pdf->Output();
?>