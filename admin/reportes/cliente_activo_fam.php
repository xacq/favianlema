...
function Header() // Cabecera de página
{
    ...
    $this->Cell(65,10,'LISTA DE CLIENTES - CASOS FAMILIA',0,0,'C');    // Título
...
$query = "SELECT * FROM fav_clientes INNER JOIN fav_familia WHERE fav_cli_codigo = fav_fam_codigo";
...
while ($row = mysqli_fetch_array($resultado)){
    ...
    $pdf->Cell(30,6, utf8_decode($row['fav_fam_proceso']),1,0,0);
