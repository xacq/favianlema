...
function Header() // Cabecera de página
{
    ...
    $this->Cell(65,10,'LISTA DE CLIENTES - CASOS SENAGUA',0,0,'C');    // Título
...
$query = "SELECT * FROM fav_clientes INNER JOIN fav_senagua WHERE fav_cli_codigo = fav_sen_codigo";
...
while ($row = mysqli_fetch_array($resultado)){
    ...
    $pdf->Cell(50,6, utf8_decode($row['fav_sen_proceso']),1,0,0);
