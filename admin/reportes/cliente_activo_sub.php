...
function Header() // Cabecera de página
{
    ...
    $this->Cell(65,10,'LISTA DE CLIENTES - CASOS SUBTIERRAS',0,0,'C');    // Título
...
$query = "SELECT * FROM fav_clientes INNER JOIN fav_subtierras WHERE fav_cli_codigo = fav_sub_codigo";
...
while ($row = mysqli_fetch_array($resultado)){
    ...
    $pdf->Cell(30,6, utf8_decode($row['fav_sub_proceso']),1,0,0);
