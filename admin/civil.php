...
$sql = "SELECT * FROM fav_codigo WHERE fav_cod_id = 1";
          ...
          <fieldset>
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6 col-xs-12">
                  <label >CODIGO</label> 
                  <input name="codigo" value="<?php echo $codigo; ?>" class="normal_input_little maximus" onkeypress="return valideKeys(event);" readonly></div> </div>
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                  <label >Nro Proceso</label> 
                  <input class="normal_input_little maximus"  onkeypress="return valideKeys(event);"  name="proceso">  </div>
                <div class="col-md-6 col-sm-12 col-xs-12">
                  <label >Nombre del Juez</label> 
                  <input class="normal_input_little maximus"   onkeypress="return valideKeys(event);" name="juez"></div></div>
            <div class="row">  
                <div class="col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                  ...
                  <input class="normal_input_little"   name="cli_identificacion"  onkeypress="return valideKey(event);"> </div>
                <div class="col-md-6 col-sm-12 col-xs-12">
                  <label>Teléfono</label> 
                  <input class="normal_input_little"   name="cli_telefono"  onkeypress="return valideKey(event);"> </div></div>
            ...
            <div class="row">
                  ...
                  <div class="col-md-6 col-sm-12 col-xs-12">
                    ...
                    <input class="normal_input_little maximus"  onkeypress="return valideKeys(event);"  name="con_nombre" > </div>
                  <div class="col-md-6 col-sm-12 col-xs-12">
                    <label >Identificación</label> 
                    <input class="normal_input_little"   name="con_identificacion"  onkeypress="return valideKey(event);"> </div>
                  <div class="col-md-6 col-sm-12 col-xs-12">
                    <label>Teléfono</label> 
                    <input class="normal_input_little"   name="con_telefono" size="15"  onkeypress="return valideKey(event);"> </div>
                  </div>
