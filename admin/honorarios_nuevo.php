...
?>
      ...
      <div class="container">
        ...
        <form class="normal_form" action="./actions/buscar_honorarios.php" method="POST">
          ...
          <fieldset>
            <legend class="form_title maximus" style="text-align: right;">Ingrese el codigo del nuevo cliente</legend>
            <div class="row">
