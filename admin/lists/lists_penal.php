...
<div class="container ">
        ...
        <p class="normal_linea maximus"><br>Seccion Penal</p>
         <fieldset>
         <legend class="form_title maximus" style="text-align:right;">lista de clientes ACTIVOS</legend>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  $query = "SELECT * FROM fav_clientes WHERE fav_cli_tipo = 'penal' AND fav_cli_estado = 'no' ORDER BY fav_cli_codigo DESC";
         ...
         <legend class="form_title maximus" style="text-align:right; background-color:orange;color:black;">lista de clientes INACTIVOS</legend>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  $query = "SELECT * FROM fav_clientes WHERE fav_cli_tipo = 'penal' AND fav_cli_estado = 'si' ORDER BY fav_cli_codigo";
                  $resultado = mysqli_query($conexion, $query);
                  while ($row = mysqli_fetch_array($resultado)){?>
                    <tr>
                                <td><a href="../edit/edit_user.php?id=<?php echo $row['fav_cli_id']?>" class="marca4" onclick="return confirmar('¿Está seguro que desea editar el registro?')">  <i class="tf-ion-ios-compose-outline"></i> EDIT </a></td>
