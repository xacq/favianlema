...
<div class="container ">
        ...
        <p class="normal_linea maximus"><br>Seccion Subsecretaria de Tierras</p>
         <fieldset>
              ...
              <table class="table table-hover">
                <thead class="text-center maximus">
                  <tr>
                    ...
                    <th scope="col">cliente / Proceso / Denunciado</th>
                ...
                <tbody>
                  ...
                  $query = "SELECT * FROM fav_clientes WHERE fav_cli_tipo = 'subtierras' AND fav_cli_estado = 'no' ORDER BY fav_cli_codigo DESC";
         ...
         <legend class="form_title maximus" style="text-align:right; background-color:orange;color:black;">lista de clientes INACTIVOS</legend>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  $query = "SELECT * FROM fav_clientes WHERE fav_cli_tipo = 'subtierras' AND fav_cli_estado = 'si' ORDER BY fav_cli_codigo";
                  $resultado = mysqli_query($conexion, $query);
                  while ($row = mysqli_fetch_array($resultado)){?>
                    <tr>
