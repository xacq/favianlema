         ...
         <legend class="form_title maximus" style="text-align:right;">lista de clientes ACTIVOS</legend>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  $query = "SELECT * FROM fav_clientes WHERE fav_cli_tipo = 'constitucional' AND fav_cli_estado = 'no' ORDER BY fav_cli_codigo DESC";
         ...
         <legend class="form_title maximus" style="text-align:right; background-color:orange;color:black;">lista de clientes INACTIVOS</legend>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  $query = "SELECT * FROM fav_clientes WHERE fav_cli_tipo = 'constitucional' AND fav_cli_estado = 'si' ORDER BY fav_cli_codigo";
                  $resultado = mysqli_query($conexion, $query);
                  while ($row = mysqli_fetch_array($resultado)){?>
                    <tr>
