...
?>
      ...
      <div class="container ">
        ...
        <p class="normal_linea"><br>SECCION USUARIOS</p>
         <fieldset>
            <legend class="form_title maximus" style="text-align: right;">Registro de Ingresos de HOY</legend>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  $query = "SELECT * FROM fav_reg_ingreso WHERE DATE(fav_reg_fecha_creacion) = CURDATE() ORDER BY fav_reg_fecha_creacion desc";
