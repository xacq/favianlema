...
$sql = "SELECT * FROM fav_codigo WHERE fav_cod_id = 3";
        ...
        <form class="normal_form" method="POST" action="./actions/registrar_familia.php">
          ...
          <fieldset>
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <label >Juez</label> 
                <input name="juez" class="normal_input_little maximus"  onkeypress="return valideKeys(event);" ></div>
            </div>      

            <div class="row">
              <div class="col-md-6 col-sm-12 col-xs-12">
                  <label class="marca1">Cliente</label> 
                  <select class="normal_input_little"  name="cliente"  onkeypress="return valideKeys(event);" required> 
              ...
              <div class="col-md-6 col-sm-12 col-xs-12">
                ...
                <input class="normal_input_little"   name="cli_telefono" onkeypress="return valideKey(event);" ></div>  
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-12 col-xs-12">
                <label >Teléfono</label> 
                <input class="normal_input_little"  name="con_telefono"  onkeypress="return valideKey(event);"></div>  
            </div>    
          </fieldset>
