...
?>
      ...
      <div class="container"> 
        <form class="normal_form" method="POST" action="./actions/buscar_proceso.php">
          <!-- CABECERA -->
          <div class="row text-center" style="text-align:right;background-color:orange;">
           ...
           <div class="col-sm-4">
            <label>  <?php echo "Fecha/Hora: ".date("j/n/Y, h:i A"); ?></label>
          	...
          	<p class="normal_linea"><br>SECCION BUSCAR CLIENTE POR PROCESO</p>
          	<fieldset>
            	<legend class="form_title maximus" style="text-align: right;">Ingreso el proceso del cliente</legend>
            	<div class="row">
          	...
          	<div class="col-md-12 col-sm-12 col-xs-12 text-center">  
            	<input name="buscar_proceso" type="submit" class="btn btn-main" value="BUSCAR">
          	</div>  
    	</form>
      </div>
