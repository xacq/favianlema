...
?>
      <div class="container">
        <form class="normal_form" method="POST" action="./actions/eliminar_cliente.php">
          ...
          <legend class="form_title maximus" style="background-color: orangered; color:black;">ELIMINAR</legend>
          <fieldset>
            <legend class="form_title maximus" style="background-color: orangered; color:black;text-align: right;">Ingrese el codigo del cliente a eliminar</legend>
            <div class="row">
        ...
        <form class="normal_form" method="POST" action="./actions/buscar_nombre.php">
          ...
          <legend class="form_title maximus" style="background-color: orangered; color:black;">ELIMINAR</legend>  
          <fieldset>
            <legend class="form_title maximus" style="background-color: orangered; color:black;text-align: right;">Ingreso el nombre del cliente a eliminar</legend>
            <div class="row">
            <div class="col-md-3 col-sm-3 col-xs-1"></div>
              <div class="col-md-6 col-sm-6 col-xs-10">
                  <label >NOMBRE</label> 
                  <input name="nombre" class="normal_input_little maximus" onkeypress="return valideKeys(event);" ></div>
            </div>
          </fieldset>       
          <div class="col-md-12 col-sm-12 col-xs-12 text-center">  
